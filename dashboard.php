...
<head>
    ...
    <title>AUAF Students Management System</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-fixed-top" role="navigation" style="background-color:#651fff">
            ...
            <div class="navbar-header">
                ...
                <img src="images/Logo.png" alt="img" style="max-width: 150px; max-height: 150px; position:fixed"></img></a>
...
?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">   
        ...
        <?php }else{?>
          <option value="STAFF">Instractur</option>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">          
        ...
        <button type="submit" class="btn btn-default" style="background-color: #9e9e9e; border-radius:20px">Save</button>
        </form>
          <button type="button" class="btn btn-default" data-dismiss="modal" style="background-color: #9e9e9e; border-radius:20px">Cancel</button>
        </div>
        </div>
        </div>
        </div>
